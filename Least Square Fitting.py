...
Parser.add_argument('--pathToVideo', default='ball_video1.mp4', help=', Default: ./video/ball_video1.mp4')
...
try:
    ...
    x, y = zip(*coordinates)
    print("Output for the sensor with no noise \n")
    ls = leastSquare(coordinates)
    plotPlots(x, y, ls, "LS Fitting", "LS fitting for Sensor without any noise ")
    plt.savefig("sensor_without_noise.png", bbox_inches='tight')    
